...
#define PACKAGE_STRING "SL-OPENTHREAD 1.0.2.0 GitHub-f411a412bee"
...
#define PACKAGE_VERSION "1.0.2.0 GitHub-f411a412bee"

/* Define to 1 if you have the ANSI C header files. */
#define STDC_HEADERS 1

/* Version number of package */
#define VERSION "1.0.2.0 GitHub-f411a412bee"
